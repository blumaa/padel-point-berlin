...
export function PadelPointBerlin() {
  ...
  useGSAP(
    () => {
      ...
      //     opacity: 1,
      //     duration: 2,
      //     ease: "bounce.out", // The magic happens here
      //     transformOrigin: "center center",
      //   },
      //   3,
      // );
      // 1. The initial drop from the sky to the "floor"
      tl.fromTo(
        "#ppb-ball-spin",
        { y: -250 }, // Starting point (High in the air)
        {
          y: 0, // Impact point (130px below the original spot)
          // duration: 0.5,
          // ease: "power2.in", // Fast fall
          duration: 1.2, // Faster duration makes it feel snappier
          ease: "bounce.out",
        },
        3,
      );
